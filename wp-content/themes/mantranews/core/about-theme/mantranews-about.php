...
class News_Portal_About {
	...
	public function welcome_notice() {
		...
		<div id="mt-theme-message" class="updated mantranews-message">
			<a class="mantranews-message-close notice-dismiss" href="<?php echo esc_url( wp_nonce_url( remove_query_arg( array( 'activated' ), add_query_arg( 'mantranews-hide-notice', 'welcome' ) ), 'mantranews_hide_notices_nonce', '_mantranews_notice_nonce' ) ); ?>"><?php esc_html_e( 'Dismiss', 'mantranews' ); ?></a>
			...
			<p class="submit">
				<a class="button button-primary button-hero" href="<?php echo esc_url( admin_url( 'themes.php?page=mantranews-welcome' ) ); ?>"><?php printf( esc_html__( 'Get started with %1$s', 'mantranews' ), esc_html( $theme_name ) ); ?></a>
			</p>
		</div>
		<?php
	}
	...
	private function intro() {
		...
		<p class="mantranews-actions">
			<a href="<?php echo esc_url( $theme_uri ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Theme Info', 'mantranews' ); ?></a>
		...
		<h2 class="nav-tab-wrapper">
			<a class="nav-tab <?php if ( empty( $_GET['tab'] ) && $_GET['page'] == 'mantranews-welcome' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'mantranews-welcome' ), 'themes.php' ) ) ); ?>">
				<?php echo esc_html( $theme->display( 'Name' ) ); ?>
			</a>
			
			<a class="nav-tab <?php if ( isset( $_GET['tab'] ) && $_GET['tab'] == 'free_vs_pro' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'mantranews-welcome', 'tab' => 'free_vs_pro' ), 'themes.php' ) ) ); ?>">
				<?php esc_html_e( 'Free Vs Pro', 'mantranews' ); ?>
			</a>

			<a class="nav-tab <?php if ( isset( $_GET['tab'] ) && $_GET['tab'] == 'more_themes' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'mantranews-welcome', 'tab' => 'more_themes' ), 'themes.php' ) ) ); ?>">
				<?php esc_html_e( 'More Themes', 'mantranews' ); ?>
			</a>

			<a class="nav-tab <?php if ( isset( $_GET['tab'] ) && $_GET['tab'] == 'changelog' ) echo 'nav-tab-active'; ?>" href="<?php echo esc_url( admin_url( add_query_arg( array( 'page' => 'mantranews-welcome', 'tab' => 'changelog' ), 'themes.php' ) ) ); ?>">
			...
			<div class="changelog point-releases">
				<div class="under-the-hood two-col">
					<div class="col">
						...
						<p><a href="<?php echo esc_url( admin_url( 'customize.php' ) ); ?>" class="button button-secondary"><?php esc_html_e( 'Customize', 'mantranews' ); ?></a></p>
					</div>
					...
					<div class="col">
						...
						<p><a href="<?php echo esc_url( 'https://mantrabrain.com/docs-category/mantranews-wordpress-theme/' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Documentation', 'mantranews' ); ?></a></p>
					</div>
					...
					<div class="col">
						...
						<p><a href="<?php echo esc_url( 'https://mantrabrain.com/support-forum/' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Support', 'mantranews' ); ?></a></p>
					</div>
					...
					<div class="col">
						...
						<p><a href="<?php echo esc_url( 'https://mantrabrain.com/customization/' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Customization', 'mantranews' ); ?></a></p>
					</div>
					...
					<div class="col">
						...
						<p>
							<a href="<?php echo esc_url( 'https://translate.wordpress.org/projects/wp-themes/mantranews' ); ?>" class="button button-secondary" target="_blank"><?php printf( esc_html__( 'Translate %1$s', 'mantranews' ), esc_html( $theme_name ) ); ?></a>
						</p>
					</div>
				</div>
			</div><!-- .point-releases -->
						...
						foreach ( $themes->themes as $theme ) {
							if( $active_theme == $theme->name ) {					?>
								...
								<div id="<?php echo esc_attr( $theme->slug ); ?>" class="theme active">
									...
									<h3 class="theme-name" id="mantranews-name"><strong><?php esc_html_e( 'Active', 'mantranews' ); ?></strong>: <?php echo esc_html( $theme->name ); ?></h3>
									<div class="theme-actions">
										<a class="button button-primary customize load-customize hide-if-no-customize" href="<?php echo esc_url( get_site_url(). '/wp-admin/customize.php' ); ?>"><?php esc_html_e( 'Customize', 'mantranews' ); ?></a>
									</div>
								</div><!-- .theme active -->
						<?php
							$counter++;
							...
							?>
								<div id="<?php echo esc_attr( $theme->slug ); ?>" class="theme">
									...
									<div class="theme-actions">
										...
										?>
											<!-- Install Button -->
											<a data-toggle="tooltip" data-placement="bottom" title="<?php echo esc_attr( 'Downloaded ', 'mantranews' ). number_format( $theme_details->downloaded ).' '.esc_attr( 'times', 'mantranews' ); ?>" class="button button-secondary activate" href="<?php echo esc_url( wp_nonce_url( $install_url, 'install-theme_' . $theme->slug ) ); ?>" ><?php esc_html_e( 'Install Now', 'mantranews' ); ?></a>
										<?php } ?>

										<a class="button button-primary load-customize hide-if-no-customize" target="_blank" href="<?php echo esc_url( $theme->preview_url ); ?>"><?php esc_html_e( 'Live Preview', 'mantranews' ); ?></a>
									</div>
								</div><!-- .theme -->
								<?php
							}
